...
func GlClientWaitSync(sync GLsync, flags GLbitfield, timeout GLuint64) GLenum {
	csync, csyncAllocMap := (C.GLsync)(sync), cgoAllocsUnknown
...
func GlDeleteQueries(n GLsizei, ids *GLuint) {
	cn, cnAllocMap := (C.GLsizei)(n), cgoAllocsUnknown
	cids, cidsAllocMap := (*C.GLuint)(unsafe.Pointer(ids)), cgoAllocsUnknown
...
func GlDeleteSamplers(count GLsizei, samplers *GLuint) {
	...
	csamplers, csamplersAllocMap := (*C.GLuint)(unsafe.Pointer(samplers)), cgoAllocsUnknown
...
func GlDeleteVertexArrays(n GLsizei, arrays *GLuint) {
	cn, cnAllocMap := (C.GLsizei)(n), cgoAllocsUnknown
	carrays, carraysAllocMap := (*C.GLuint)(unsafe.Pointer(arrays)), cgoAllocsUnknown
...
func GlDrawBuffers(n GLsizei, bufs *GLenum) {
	cn, cnAllocMap := (C.GLsizei)(n), cgoAllocsUnknown
	cbufs, cbufsAllocMap := (*C.GLenum)(unsafe.Pointer(bufs)), cgoAllocsUnknown
...
func GlDrawElementsInstanced(mode GLenum, count GLsizei, _type GLenum, indices unsafe.Pointer, instancecount GLsizei) {
	...
	cindices, cindicesAllocMap := indices, cgoAllocsUnknown
	cinstancecount, cinstancecountAllocMap := (C.GLsizei)(instancecount), cgoAllocsUnknown
	C.glDrawElementsInstanced(cmode, ccount, c_type, cindices, cinstancecount)
	runtime.KeepAlive(cinstancecountAllocMap)
	runtime.KeepAlive(cindicesAllocMap)
	runtime.KeepAlive(c_typeAllocMap)
	runtime.KeepAlive(ccountAllocMap)
...
func GlDrawRangeElements(mode GLenum, start GLuint, end GLuint, count GLsizei, _type GLenum, indices unsafe.Pointer) {
	...
	c_type, c_typeAllocMap := (C.GLenum)(_type), cgoAllocsUnknown
	cindices, cindicesAllocMap := indices, cgoAllocsUnknown
	C.glDrawRangeElements(cmode, cstart, cend, ccount, c_type, cindices)
	runtime.KeepAlive(cindicesAllocMap)
	runtime.KeepAlive(c_typeAllocMap)
	runtime.KeepAlive(ccountAllocMap)
...
func GlGetActiveUniformBlockName(program GLuint, uniformBlockIndex GLuint, bufSize GLsizei, length *GLsizei, uniformBlockName *GLchar) {
	...
	cbufSize, cbufSizeAllocMap := (C.GLsizei)(bufSize), cgoAllocsUnknown
	clength, clengthAllocMap := (*C.GLsizei)(unsafe.Pointer(length)), cgoAllocsUnknown
	cuniformBlockName, cuniformBlockNameAllocMap := (*C.GLchar)(unsafe.Pointer(uniformBlockName)), cgoAllocsUnknown
...
func GlGetBufferParameteri64v(target GLenum, pname GLenum, params *GLint64) {
	ctarget, ctargetAllocMap := (C.GLenum)(target), cgoAllocsUnknown
	cpname, cpnameAllocMap := (C.GLenum)(pname), cgoAllocsUnknown
	cparams, cparamsAllocMap := (*C.GLint64)(unsafe.Pointer(params)), cgoAllocsUnknown
...
func GlGetInteger64i_v(target GLenum, index GLuint, data *GLint64) {
	ctarget, ctargetAllocMap := (C.GLenum)(target), cgoAllocsUnknown
	cindex, cindexAllocMap := (C.GLuint)(index), cgoAllocsUnknown
	cdata, cdataAllocMap := (*C.GLint64)(unsafe.Pointer(data)), cgoAllocsUnknown
...
func GlGetProgramBinary(program GLuint, bufSize GLsizei, length *GLsizei, binaryFormat *GLenum, binary unsafe.Pointer) {
	...
	cbufSize, cbufSizeAllocMap := (C.GLsizei)(bufSize), cgoAllocsUnknown
	clength, clengthAllocMap := (*C.GLsizei)(unsafe.Pointer(length)), cgoAllocsUnknown
	cbinaryFormat, cbinaryFormatAllocMap := (*C.GLenum)(unsafe.Pointer(binaryFormat)), cgoAllocsUnknown
...
func GlGetSynciv(sync GLsync, pname GLenum, bufSize GLsizei, length *GLsizei, values *GLint) {
	...
	cbufSize, cbufSizeAllocMap := (C.GLsizei)(bufSize), cgoAllocsUnknown
	clength, clengthAllocMap := (*C.GLsizei)(unsafe.Pointer(length)), cgoAllocsUnknown
	cvalues, cvaluesAllocMap := (*C.GLint)(unsafe.Pointer(values)), cgoAllocsUnknown
...
func GlGetTransformFeedbackVarying(program GLuint, index GLuint, bufSize GLsizei, length *GLsizei, size *GLsizei, _type *GLenum, name *GLchar) {
	...
	cbufSize, cbufSizeAllocMap := (C.GLsizei)(bufSize), cgoAllocsUnknown
	clength, clengthAllocMap := (*C.GLsizei)(unsafe.Pointer(length)), cgoAllocsUnknown
	csize, csizeAllocMap := (*C.GLsizei)(unsafe.Pointer(size)), cgoAllocsUnknown
	c_type, c_typeAllocMap := (*C.GLenum)(unsafe.Pointer(_type)), cgoAllocsUnknown
	cname, cnameAllocMap := (*C.GLchar)(unsafe.Pointer(name)), cgoAllocsUnknown
	C.glGetTransformFeedbackVarying(cprogram, cindex, cbufSize, clength, csize, c_type, cname)
	runtime.KeepAlive(cnameAllocMap)
	runtime.KeepAlive(c_typeAllocMap)
	runtime.KeepAlive(csizeAllocMap)
	runtime.KeepAlive(clengthAllocMap)
...
func GlInvalidateFramebuffer(target GLenum, numAttachments GLsizei, attachments *GLenum) {
	...
	cattachments, cattachmentsAllocMap := (*C.GLenum)(unsafe.Pointer(attachments)), cgoAllocsUnknown
...
func GlTexImage3D(target GLenum, level GLint, internalformat GLint, width GLsizei, height GLsizei, depth GLsizei, border GLint, format GLenum, _type GLenum, pixels unsafe.Pointer) {
	...
	c_type, c_typeAllocMap := (C.GLenum)(_type), cgoAllocsUnknown
	cpixels, cpixelsAllocMap := pixels, cgoAllocsUnknown
	C.glTexImage3D(ctarget, clevel, cinternalformat, cwidth, cheight, cdepth, cborder, cformat, c_type, cpixels)
	runtime.KeepAlive(cpixelsAllocMap)
	runtime.KeepAlive(c_typeAllocMap)
	runtime.KeepAlive(cformatAllocMap)
	runtime.KeepAlive(cborderAllocMap)
...
func GlTexSubImage3D(target GLenum, level GLint, xoffset GLint, yoffset GLint, zoffset GLint, width GLsizei, height GLsizei, depth GLsizei, format GLenum, _type GLenum, pixels unsafe.Pointer) {
	...
	c_type, c_typeAllocMap := (C.GLenum)(_type), cgoAllocsUnknown
	cpixels, cpixelsAllocMap := pixels, cgoAllocsUnknown
	C.glTexSubImage3D(ctarget, clevel, cxoffset, cyoffset, czoffset, cwidth, cheight, cdepth, cformat, c_type, cpixels)
	runtime.KeepAlive(cpixelsAllocMap)
	runtime.KeepAlive(c_typeAllocMap)
	runtime.KeepAlive(cformatAllocMap)
	runtime.KeepAlive(cdepthAllocMap)
...
func GlVertexAttribI4iv(index GLuint, v *GLint) {
	cindex, cindexAllocMap := (C.GLuint)(index), cgoAllocsUnknown
	cv, cvAllocMap := (*C.GLint)(unsafe.Pointer(v)), cgoAllocsUnknown
...
func GlVertexAttribI4uiv(index GLuint, v *GLuint) {
	cindex, cindexAllocMap := (C.GLuint)(index), cgoAllocsUnknown
	cv, cvAllocMap := (*C.GLuint)(unsafe.Pointer(v)), cgoAllocsUnknown
...
func GlVertexAttribIPointer(index GLuint, size GLint, _type GLenum, stride GLsizei, pointer unsafe.Pointer) {
	...
	cpointer, cpointerAllocMap := pointer, cgoAllocsUnknown
	C.glVertexAttribIPointer(cindex, csize, c_type, cstride, cpointer)
	runtime.KeepAlive(cpointerAllocMap)
