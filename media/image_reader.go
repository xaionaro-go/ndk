...
func (h *ImageReader) UintPtr() uintptr {
	return uintptr(unsafe.Pointer(h.ptr))
}

// NewImageReaderFromUintPtr wraps a uintptr as a ImageReader.
// The caller must ensure ptr points to a valid AImageReader.
func NewImageReaderFromUintPtr(ptr uintptr) *ImageReader {
	return &ImageReader{ptr: (*capi.AImageReader)(unsafe.Pointer(ptr))}
}
